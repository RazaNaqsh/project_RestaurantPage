(() => {
	...
	var e,
		...
		v = {
			426: (e, t, n) => {
				...
				i.push([
					e.id,
					"@import url(https://fonts.googleapis.com/css2?family=Great+Vibes&family=Marck+Script&family=Nunito:wght@400;700;900&display=swap);",
				]),
					i.push([
						e.id,
	...
	(h.n = (e) => {
		...
		(function () {
			...
			(t.textContent = "Challe Fen Challe"),
				t.classList.add("content__title"),
				e.append(t);
		})(),
